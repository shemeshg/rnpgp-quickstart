...
static bool
rnp_cfg_set_ks_info(RnpCoreParams &cfg)
{
...
bool load_keyring(bool secret, rnp_ffi_t ffi, RnpCoreParams &cfg)
{
...
bool load_keyrings(bool loadsecret, rnp_ffi_t ffi, RnpCoreParams &cfg)
{
    /* Read public keys */
